...
class _AuthCardState extends State<AuthCard>
  ...
  late Animation<Size> _heightAnumation;
  ...
  void _submit() async {
    ...
    try {
      ...
      if (e.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = 'This is not a valid email adresse!';
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: AnimatedContainer(
        ...
        // height: _heightAnumation.value.height,
        // constraints: BoxConstraints(minHeight: _heightAnumation.value.height),
        constraints:
